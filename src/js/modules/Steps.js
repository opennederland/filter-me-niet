...
export default class Steps {
  ...
  setValue(step, e) {
    ...
    const labels = {
      upload_type: "Ik upload <strong>[value]</strong>",
      personal_data: "Ik stuur <strong>[value]</strong> persoonsgegevens mee",
    };
    ...
    if (step.querySelector("[data-step-value]") && name === "conditions") {
      if (value === "share") {
        step.querySelector("[data-step-value]").innerHTML =
          "Mijn werk mag worden <strong>gedeeld</strong>";
      } else if (value === "share_edit") {
        step.querySelector("[data-step-value]").innerHTML =
          "Mijn werk mag worden <strong>gedeeld</strong> en <strong>bewerkt</strong>";
      } else if (value === "share_commercial") {
        step.querySelector("[data-step-value]").innerHTML =
          "Mijn werk mag worden <strong>gedeeld</strong> en mag gebruikt worden voor <strong>commerciële</strong> doeleinden.";
      } else if (value === "share_edit_commercial") {
        step.querySelector("[data-step-value]").innerHTML =
          "Mijn werk mag worden <strong>gedeeld</strong>, <strong>bewerkt</strong> en mag gebruikt worden voor <strong>commerciële</strong> doeleinden.";
      } else if (value === "none") {
        step.querySelector("[data-step-value]").innerHTML =
          "Mijn werk mag <strong>niet</strong> worden gedeeld";
      }
    }
  ...
  createDeclarationOfIntent() {
    ...
    const language =
      document.querySelector('select[name="language"]').value || "nl";
  ...
  copyDeclarationOfIntent() {
    const labels = {
      default: "Kopieer intentieverklaring",
